<div class="row">
    <div class="col-md-4">
        ...
        <div class="modal fade" id="create-otras-capacidades" tabindex="-1" role="dialog" aria-labelledby="modal-default"
            aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal- modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title font-weight-normal" id="modal-title-default">CREAR OTRAS CAPACIDADES </h6>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 card">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('otras-capacidad.create') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group input-group-outline mt-3 col-md-12">
                                                        <select name="proveedores_otra" class="form-control" id="proveedores_otra">
