<div class="row">
    <div class="col-md-4">
        ...
        <div class="modal fade" id="create-batch-cotizacion" tabindex="-1" role="dialog" aria-labelledby="modal-default"
            aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal- modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title font-weight-normal" id="modal-title-default">CARGAR COTIZACION</h6>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('cotizacion.import.excel') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" id="estudio_id" name="estudio_id">
                                                <div class="col">
                                                    ...
                                                    <div class="input-group input-group-outline mt-3 col-md-12">
                                                        <label for="documento_cargar" style="width: 100%;">
                                                            <input type="file" class="form-control" style="width: 100%;"
                                                                name="cargar_documento_cotizacion" id="cargar_documento_cotizacion" required>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
